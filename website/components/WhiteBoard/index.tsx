...
import { Color, Layer, LayerType, CanvasState, CanvasMode, Camera, Side, XYWH, Point } from '../../types/whiteboard';
...
import SelectionBox from '../ui/whiteboard/SelectionBox';
import { nanoid } from 'nanoid';
import { useRouter } from 'next/router';
import LayerComponent from '../ui/whiteboard/LayerComponent';
import SelectionTools from '../ui/whiteboard/SelectionTools';
import useDisableScrollBounce from '../ui/whiteboard/hooks/useDisableScrollBounce';
import useDeleteLayers from '../ui/whiteboard/hooks/useDeleteLayers';
import MultiplayerGuides from '../ui/whiteboard/MultiplayerGuides';
import Path from '../ui/whiteboard/Path';
import ToolsBar from '../ui/whiteboard/ToolsBar';

const MAX_LAYERS = 100;

export default function Whiteboard() {
    const roomId = 'my_room';
...
function Canvas() {
    ...
    const insertLayer = useMutation(
        ({ storage, setMyPresence }, layerType: LayerType.Ellipse | LayerType.Rectangle, position: Point) => {
